        ...
        <>
        {
            loading? (
                <div className="flex items-center justify-center h-screen">
                  <svg aria-hidden="true" className=" w-32 h-32 text-white animate-spin  fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex justify-center items-center my-12">
                    ...
                    <BookMarkBtn data={d}/>
                                      ...
                                      <h2 className=" line-clamp-1 md:text-lg">{d.name}</h2>
                                      </div>
                                    </div>
                                )
                              })
