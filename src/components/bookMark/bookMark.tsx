...
import { Tdata } from "../../type/dataType";
 {/*storing saved games in this component*/}
const BookMark = () => {
    const {item,handleRemove}=useMyContext()
    return ( 
      <div className="container px-7 sm:px-12 mt-9 mx-auto">
          {/*when we dont have any saved Games show this*/}
        {!item.length && <h1 className="text-center mt-24 text-3xl sm:text-5xl">Theres Is No Saved Game Yet</h1> }
