   ...
   {/* serach input state */}
    ...
    <div className="flex justify-between items-center px-2 lg:px-7 my-8 lg:my-11 scrollbar">
     ...
     <h1 className="text-2xl">All Games</h1>
      {/* serach input */}
     <input className="outline-none py-1 rounded-lg border-2 border-blue-900 w-1/2 sm:w-2/4 text-center" onChange={(e=>setSearch(e.target.value))} type="search"  placeholder="search Game"/>
     </div>
